from common.arguments_3dhp import parse_args
import os
args = parse_args()
...
from common.D3DP_Grap2Eq_3dhp import *
...
#Connections for MPI-INF-3DHP dataset
connections = {0: [16], 1: [2,5,15,16], 2: [1,3], 3:[2,4], 4: [3], 5: [1,6], 6:[5,7], 7:[6], 8:[9,14], 9:[8,10], 10:[9], 11:[12,14], 12:[11,13], 13: [12], 14: [8,11], 15: [1,14], 16: [0,1]}
...
if not args.evaluate:
    ...
    train_generator = ChunkedGenerator_Seq(args.batch_size, None, out_poses_3d_train, out_poses_2d_train, args.number_of_frames, args.stride,
