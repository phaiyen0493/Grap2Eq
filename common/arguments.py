...
def parse_args():
    ...
    parser.add_argument('-lrd', '--lr-decay', default=0.995, type=float, metavar='LR', help='learning rate decay per epoch')
    ...
    parser.add_argument('-no-da', '--no-data-augmentation', dest='data_acoverugmentation', action='store_false',
    ...
    parser.add_argument('-tem-beta', '--temporal-beta', default=5, type=float,
