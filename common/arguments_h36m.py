...
def parse_args():
    ...
    parser.add_argument('--save_lmin', default=40.50, type=float, metavar='N')
    parser.add_argument('--save_lmax', default=42.75, type=float, metavar='N')
    parser.add_argument('--save_emin', default=20, type=int, metavar='N')
    ...
    parser.add_argument('-c', '--checkpoint', default='checkpoint/model_h36m', type=str, metavar='PATH',
    ...
    parser.add_argument('-tem-alpha', '--temporal-alpha', default=0.125, type=float,
                        metavar='N', help='temporal alpha to decide the rate of decreasing for temporal graph attn')
    parser.add_argument('-tem-beta', '--temporal-beta', default=5, type=int,
    ...
    parser.add_argument('--input-npz', type=str,
                        metavar='STR', help='2d keypoints input')
