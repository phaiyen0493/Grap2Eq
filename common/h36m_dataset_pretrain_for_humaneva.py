...
class Human36mDataset(MocapDataset):
    def __init__(self, path):
        super().__init__(fps=50, skeleton=humaneva_skeleton)
        ...
        for subject, actions in data.items():
            ...
            for action_name, positions in actions.items():
                positions = np.delete(positions, [4, 5, 9, 10, 11, 16, 20, 21, 22, 23, 24, 28, 29, 30, 31], axis=1)
                self._data[subject][action_name] = {
                    'positions': human36m2humaneva_convert(positions),
